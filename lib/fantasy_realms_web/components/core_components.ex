defmodule FantasyRealmsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FantasyRealmsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FantasyRealmsWeb.Gettext, "errors", msg, opts)
    end
  end
